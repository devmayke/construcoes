        ...
        <div className='localizacao'>
          <div className='wrapper'>
            ...
            <ul className='menu-redes'>
              <li className="animate__animated animate__pulse animate__infinite"><img onClick={e => { linkTo('facebook') }} src={facebook} alt="" /></li>
              <li className="animate__animated animate__pulse animate__infinite"><img onClick={e => { linkTo('tiktok') }} src={tiktok} alt="" /></li>
              <li className="animate__animated animate__pulse animate__infinite"><img onClick={e => { linkTo('instagram') }} src={instagram} alt="" /></li>
              <li className="animate__animated animate__pulse animate__infinite"><img onClick={e => { linkTo('whatsapp') }} src={whatsapp} alt="" /></li>
            </ul>
